...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/dogcare/admin_dogcare_detail.css" />
  <script defer src="${pageContext.request.contextPath}/assets/js/dogcare/applystate_modal.js"></script>
</head>
      ...
      <div class="admin-main-content">
        <div class="doglog-detail-container">
          ...
          <div class="detail-info-container">
            <div class="detail-info-name">작성자 | ${care.userNickname}</div>
            <div class="detail-info-caredate">봉사 날짜 | ${care.careDate}</div>
            <div class="detail-info-date">작성일 | ${care.careWriteDate}</div>
          </div>
          ...
          <div class="detail-footer-container">
            <button class="apply-status" id="applyStatusBtn">
              신청현황 <br>${care.applyCount}/${care.careRecruit}
            </button>
          </div>
