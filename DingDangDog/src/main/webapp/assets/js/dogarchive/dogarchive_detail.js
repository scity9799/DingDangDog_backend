...
function renderArchiveDetail() {
    ...
    btnShelterLink.href = `/shelter_detail.ar?id=${archiveDetailData.shelterId}`;
    btnEdit.href = `/DingDangDog/archive/update.ar?dogNumber=${archiveDetailData.id}`;
}
