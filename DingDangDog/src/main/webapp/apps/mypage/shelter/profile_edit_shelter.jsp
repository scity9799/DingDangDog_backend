...
<head>
    ...
    <title>내 정보 변경</title>
    <link rel="stylesheet" href="./../../../assets/css/mypage/shelter/profile_edit_shelter.css" />
    <script src="./../../../assets/js/mypage/shelter/profile_edit_shelter.js"></script>
</head>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="edit-control">
                                ...
                                <div class="edit-row">
                                    ...
                                    <div class="edit-value">행복 보호소</div>
                                </div>
                                ...
                                <div class="edit-row">
                                    ...
                                    <div class="file-upload-wrap">
                                        ...
                                        <button type="button" id="shelter-file-btn" class="action-btn">파일등록</button>
                                ...
                                <div class="edit-bottom">
                                    ...
                                    <a href="./mypage_shelter.html" class="complete-btn">변경 완료</a>
                                </div>
